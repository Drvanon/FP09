...
It is possible to get into an impossible situation when performing the
configuration, namely that changing a weight worsens the output and no other
setting improves the situation. In such a scenario it has been found helpful to
increase the population size for each neuron. Though the starting population was
2, 4 were needed to get acceptable output.
