...
computations.  We now want to evaluate how a single neuron behaves under the influence
 ...
 %% Here: 1. --> effect of changing parameters drvifall,  drviout: single 
 result and averaged out one  (<50)
...
firing rate for each neuron and pliot it against the CVs of inter-spike intervals.  %% insert 1. 
