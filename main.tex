...
computations.  We now want to evaluate how a single neuron behaves under the influence
 ...
 %% Here: 1. --> effect of changing parameters drvifall,  drviout: single result and averaged out one  (<50)
...
(\textbf{I}).  The behaviour of a synapse is determined by the parameters $\tau_\text{rec}$ and $\tau_\text{facil}$ which govern the evolution according to 
\begin{align*}
	R + E + I &= 1 \\
